...
public class BjoernercompleteFactoryImpl extends EFactoryImpl implements BjoernercompleteFactory {
	...
	public static BjoernercompleteFactory init() {
		try {
			BjoernercompleteFactory theBjoernercompleteFactory = (BjoernercompleteFactory)EPackage.Registry.INSTANCE.getEFactory(BjoernercompletePackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BjoernercompletePackage.CROSSING: return createCrossing();
			case BjoernercompletePackage.TERMINAL: return createTerminal();
			case BjoernercompletePackage.DIRECTION: return createDirection();
			default:
