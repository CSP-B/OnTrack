...
public class BjoernerCompleteViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return ConnectorEditPart.VISUAL_ID == visualID
				|| LinearEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case LinearEditPart.VISUAL_ID:
			return createLinear_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case SignalEditPart.VISUAL_ID:
			return createSignal_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case PointEditPart.VISUAL_ID:
			return createPoint_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case ControlTableEditPart.VISUAL_ID:
			return createControlTable_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case SignalPlacedOnLinearEditPart.VISUAL_ID:
			return createSignalPlacedOnLinear_4001(containerView, index,
					persisted, preferencesHint);
		case UnitHasC1EditPart.VISUAL_ID:
			return createUnitHasC1_4002(containerView, index, persisted,
					preferencesHint);
		case UnitHasC2EditPart.VISUAL_ID:
			return createUnitHasC2_4003(containerView, index, persisted,
					preferencesHint);
		case SignalPlacedAtConnectorEditPart.VISUAL_ID:
			return createSignalPlacedAtConnector_4004(containerView, index,
					persisted, preferencesHint);
		case PointHasC3EditPart.VISUAL_ID:
			return createPointHasC3_4005(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createLinear_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Node createPoint_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createControlTable_2005(EObject domainElement,
	 ...
	 * @generated
	 */
	public Edge createSignalPlacedOnLinear_4001(View containerView, int index,
	 ...
	 * @generated
	 */
	public Edge createUnitHasC1_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createUnitHasC2_4003(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createSignalPlacedAtConnector_4004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createPointHasC3_4005(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
