...
public class BjoernerCompleteVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case RailDiagramEditPart.VISUAL_ID:
			...
			if (BjoernercompletePackage.eINSTANCE.getLinear().isSuperTypeOf(
					domainElement.eClass())) {
				return LinearEditPart.VISUAL_ID;
			}
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case RailDiagramEditPart.VISUAL_ID:
			...
			if (LinearEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case LinearEditPart.VISUAL_ID:
			if (LinearNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
