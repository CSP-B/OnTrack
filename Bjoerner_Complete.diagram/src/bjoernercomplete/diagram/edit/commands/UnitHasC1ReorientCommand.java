 ...
 * @generated
 */
public class UnitHasC1ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public UnitHasC1ReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistUnitHasC1_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistUnitHasC1_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setHasC1(null);
		getNewSource().setHasC1(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setHasC1(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
