 ...
 * @generated
 */
public class PointHasC3ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PointHasC3ReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPointHasC3_4005(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPointHasC3_4005(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setHasC3(null);
		getNewSource().setHasC3(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setHasC3(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
