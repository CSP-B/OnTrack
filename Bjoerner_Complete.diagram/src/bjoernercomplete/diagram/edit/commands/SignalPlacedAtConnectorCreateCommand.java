 ...
 * @generated
 */
public class SignalPlacedAtConnectorCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SignalPlacedAtConnectorCreateCommand(
	...
	public boolean canExecute() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateSignalPlacedAtConnector_4004(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setPlacedAtConnector(getTarget());
		}
