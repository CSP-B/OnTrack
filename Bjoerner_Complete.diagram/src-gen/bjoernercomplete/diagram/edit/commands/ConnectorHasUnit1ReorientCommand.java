 ...
 * @generated
 */
public class ConnectorHasUnit1ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectorHasUnit1ReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConnectorHasUnit1_4015(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConnectorHasUnit1_4015(getOldSource(), getNewTarget());
	}
