 ...
 * @generated
 */
public class PointHasC3_PointCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PointHasC3_PointCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreatePointHasC3_Point_4001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setHasC3_Point(getTarget());
		}
