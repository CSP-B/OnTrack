 ...
 * @generated
 */
public class PointHasPointDirectionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PointHasPointDirectionCreateCommand(
	...
	public boolean canExecute() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreatePointHasPointDirection_4004(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHasPointDirection().add(getTarget());
		}
