 ...
 * @generated
 */
public class SignalPlacedAtReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SignalPlacedAtReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSignalPlacedAt_4007(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSignalPlacedAt_4007(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setPlacedAt(null);
		getNewSource().setPlacedAt(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setPlacedAt(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
