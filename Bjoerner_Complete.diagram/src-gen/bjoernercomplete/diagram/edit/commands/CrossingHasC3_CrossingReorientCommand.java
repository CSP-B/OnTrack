 ...
 * @generated
 */
public class CrossingHasC3_CrossingReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CrossingHasC3_CrossingReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCrossingHasC3_Crossing_4009(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCrossingHasC3_Crossing_4009(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setHasC3_Crossing(null);
		getNewSource().setHasC3_Crossing(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setHasC3_Crossing(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
