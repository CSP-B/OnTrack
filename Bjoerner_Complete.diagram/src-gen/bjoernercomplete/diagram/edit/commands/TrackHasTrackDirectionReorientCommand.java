 ...
 * @generated
 */
public class TrackHasTrackDirectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TrackHasTrackDirectionReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Direction && newEnd instanceof Track)) {
			return false;
		}
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTrackHasTrackDirection_4003(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTrackHasTrackDirection_4003(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getHasTrackDirection().remove(getOldTarget());
		getNewSource().getHasTrackDirection().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getHasTrackDirection().remove(getOldTarget());
		getOldSource().getHasTrackDirection().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
