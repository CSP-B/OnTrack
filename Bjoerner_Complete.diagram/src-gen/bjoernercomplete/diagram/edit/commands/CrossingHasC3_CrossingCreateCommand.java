 ...
 * @generated
 */
public class CrossingHasC3_CrossingCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CrossingHasC3_CrossingCreateCommand(
	...
	public boolean canExecute() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCrossingHasC3_Crossing_4009(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setHasC3_Crossing(getTarget());
		}
