 ...
 * @generated
 */
public class ConnectorHasPointCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectorHasPointCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateConnectorHasPoint_4008(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHasPoint().add(getTarget());
		}
