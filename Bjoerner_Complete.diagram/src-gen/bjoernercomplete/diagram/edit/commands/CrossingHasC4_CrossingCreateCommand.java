 ...
 * @generated
 */
public class CrossingHasC4_CrossingCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CrossingHasC4_CrossingCreateCommand(
	...
	public boolean canExecute() {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCrossingHasC4_Crossing_4014(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setHasC4_Crossing(getTarget());
		}
