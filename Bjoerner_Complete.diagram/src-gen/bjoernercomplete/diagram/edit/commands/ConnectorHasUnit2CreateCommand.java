 ...
 * @generated
 */
public class ConnectorHasUnit2CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectorHasUnit2CreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Unit) {
			return false;
		}
		if (getSource() == null) {
		...
		return BjoernerCompleteBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateConnectorHasUnit2_4010(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHasUnit2().add(getTarget());
		}
