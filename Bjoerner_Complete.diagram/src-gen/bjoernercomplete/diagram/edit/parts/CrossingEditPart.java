...
import bjoernercomplete.diagram.edit.policies.CrossingItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CrossingEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CrossingItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CrossingNameEditPart) {
			((CrossingNameEditPart) childEditPart).setLabel(getPrimaryShape()
