 ...
 * @generated
 */
public class ConnectorIDEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ConnectorIDEditPart(View view) {
		super(view);
	}
			...
			parser = BjoernerCompleteParserProvider
					.getParser(
							...
							BjoernerCompleteVisualIDRegistry
									.getType(bjoernercomplete.diagram.edit.parts.ConnectorIDEditPart.VISUAL_ID));
		}
		return parser;
	}
