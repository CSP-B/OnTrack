 ...
 * @generated
 */
public class PointNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PointNameEditPart(View view) {
		super(view);
	}
			...
			parser = BjoernerCompleteParserProvider
					.getParser(
							...
							BjoernerCompleteVisualIDRegistry
									.getType(bjoernercomplete.diagram.edit.parts.PointNameEditPart.VISUAL_ID));
		}
		return parser;
	}
