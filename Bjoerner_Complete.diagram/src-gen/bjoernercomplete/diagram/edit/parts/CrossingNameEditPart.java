...
import bjoernercomplete.diagram.edit.policies.BjoernerCompleteTextSelectionEditPolicy;
 ...
 * @generated
 */
public class CrossingNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CrossingNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new BjoernerCompleteTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return BjoernerCompleteElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BjoernerCompleteParserProvider
					.getParser(
							BjoernerCompleteElementTypes.Crossing_2006,
							getParserElement(),
							BjoernerCompleteVisualIDRegistry
									.getType(bjoernercomplete.diagram.edit.parts.CrossingNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					BjoernerCompleteEditPartFactory
