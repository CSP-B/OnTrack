 ...
 * @generated
 */
public class BjoernerCompleteDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public BjoernerCompleteDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof BjoernerCompleteDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((BjoernerCompleteDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new BjoernerCompleteDomainNavigatorItem(
