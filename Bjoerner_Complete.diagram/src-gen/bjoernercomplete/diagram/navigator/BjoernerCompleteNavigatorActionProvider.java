 ...
 * @generated
 */
public class BjoernerCompleteNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof BjoernerCompleteNavigatorItem) {
					selectedElement = ((BjoernerCompleteNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, BjoernerCompleteDiagramEditor.ID);
