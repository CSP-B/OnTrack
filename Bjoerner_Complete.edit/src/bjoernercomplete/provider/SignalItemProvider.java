...
public class SignalItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPlacedOnLinearPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Placed On Linear feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPlacedOnLinearPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_placedOnLinear_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_placedOnLinear_feature", "_UI_Signal_type"),
				 BjoernercompletePackage.Literals.SIGNAL__PLACED_ON_LINEAR,
				 true,
				 false,
				 true,
				 null,
